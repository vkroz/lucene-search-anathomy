...
public class TestDemo extends BaseTestCase {
    ...
    private void testOneSearch(Path indexPath, String query, int expectedHitCount)
        ...
        try {
            ...
            PrintStream fakeSystemOut =
                    new PrintStream(bytes, false, Charset.defaultCharset().name());
    ...
    @Test public void testIndexSearch() throws Exception {

        Path dir = getDataPath("/docs");
        Path indexDir = createTempDir("ContribDemoTest");
        IndexFiles.main(new String[] {"-create", "-docs", dir.toString(), "-index",
                indexDir.toString()});
